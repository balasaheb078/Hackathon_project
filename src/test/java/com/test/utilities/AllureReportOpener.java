	...
	public static void openAllureReport() {
	 try {
         ...
         ProcessBuilder generate = new ProcessBuilder(
        		"C:\\Users\\2403737\\scoop\\apps\\allure\\2.34.1\\bin\\allure.bat", "generate", "target/allure-results", "-o", "target/allure-report", "--clean"
         );
         ...
         ProcessBuilder open = new ProcessBuilder(
        		 "C:\\Users\\2403737\\scoop\\apps\\allure\\2.34.1\\bin\\allure.bat", "open", "target/allure-report"
         );
         open.inheritIO();
